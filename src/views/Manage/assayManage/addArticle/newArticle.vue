...
<!--    //获取分类-->
<!--    getClassify(){-->
<!--      axios.post('/api/assay/getClassify').then(res=>{-->
<!--        // console.log(res.data)-->
<!--        if (res.data.code === "200"){-->
<!--          this.categories = res.data.data-->
<!--        } else {-->
...
<!--              type: "success",-->
<!--            });-->
<!--            this.$router.push("/assayManage/assay")-->
<!--          } else {-->
<!--            this.$message({-->
<!--              type: "info",-->
<!--              message: res.data.msg-->
...
<!--        type: 'warning'-->
<!--      }).then(()=>{-->
<!--        this.$router.push("/dashboard/psychological_article")-->
<!--      })-->
<!--    },-->
<!--    async imgAdd(pos,file){-->
<!--      let fd = new FormData();-->
...
<!--      fd.append('identifier',fileMd5)-->
<!--      // console.log('111:',fd.get('identifier'))-->
<!--      axios.post('/api/files/uploadBefore',fd)-->
<!--        .then(resp=>{-->
<!--          console.log('resp:',resp.data)-->
<!--          if (resp.data.code === '200'){-->
...
<!--              //   if (res.data.code === '200'){-->
<!--              //     successCount++-->
<!--              //     if (successCount === this.chunkCount){-->
<!--              //       this.imgID = this.imgID + res.data.data-->
<!--              //       this.$refs.md.$img2Url(pos,'/api/files/download/'+res.data.data)-->
<!--              //     }-->
<!--              //   }-->
